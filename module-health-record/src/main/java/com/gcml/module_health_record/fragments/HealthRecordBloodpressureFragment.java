...
//        mColor2.setBackgroundColor(getResources().getColor(R.color.health_record_node2_color));
        mColor2.setBackgroundColor(ContextCompat.getColor(Box.getApp(), R.color.health_record_node2_color));
...
//        ll1.setLineColor(getResources().getColor(R.color.health_record_picket_line1));
        ll1.setLineColor(ContextCompat.getColor(Box.getApp(), R.color.health_record_picket_line1));
...
//        ll2.setLineColor(getResources().getColor(R.color.health_record_picket_line1));
        ll2.setLineColor(ContextCompat.getColor(Box.getApp(), R.color.health_record_picket_line1));
...
//        ll4.setLineColor(getResources().getColor(R.color.health_record_picket_line2));
        ll4.setLineColor(ContextCompat.getColor(Box.getApp(), R.color.health_record_picket_line2));
...
//                colors1.add(getResources().getColor(R.color.health_record_node_text_color));
                colors1.add(ContextCompat.getColor(Box.getApp(), R.color.health_record_node_text_color));
            }
...
//                colors2.add(getResources().getColor(R.color.health_record_node2_color));
                colors2.add(ContextCompat.getColor(Box.getApp(), R.color.health_record_node2_color));
            }
...
//                set2.setColor(getResources().getColor(R.color.health_record_line2_color));
                set2.setColor(ContextCompat.getColor(Box.getApp(), R.color.health_record_line2_color));
                set2.setValueTextColors(colors2);
//                set2.setCircleColor(getResources().getColor(R.color.health_record_node2_color));
                set2.setCircleColor(ContextCompat.getColor(Box.getApp(), R.color.health_record_node2_color));
